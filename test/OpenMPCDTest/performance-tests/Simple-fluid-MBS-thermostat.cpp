/**
 * @file
 * This test runs a performance test with a simple fluid and
 * Maxwell-Boltzmann-Scaling (MBS) thermostat.
 */
...
static const char* const outputPath =
	"test/output/performance-tests/Simple-fluid-MBS-thermostat.txt";
...
SCENARIO(
	"Performance Test: CUDA, Simple MPC Fluid, MBS thermostat",
	"[CUDA]"
	)
{
